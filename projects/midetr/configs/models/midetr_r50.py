...
from projects.midetr.modeling import (
    DINO,
    MIDETRTransformerEncoder,
...
model = L(DINO)(
    ...
    transformer=L(MIDETRTransformer)(
        encoder=L(MIDETRTransformerEncoder)(
            embed_dim=256,
            num_heads=8,
        ...
        decoder=L(MIDETRTransformerDecoder)(
            embed_dim=256,
            num_heads=8,
            feedforward_dim=2048,
            attn_dropout=0.0,
