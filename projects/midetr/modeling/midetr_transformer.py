...
class MIDETRTransformerEncoder(TransformerLayerSequence):
    def __init__(
        self,
        embed_dim: int = 256,
        num_heads: int = 8,
        ...
        super(MIDETRTransformerEncoder, self).__init__(
    ...
    def forward(
        ...
        **kwargs,
        ...
        for layer in self.layers:
            ...
            query_per_layer.append(query)

        if self.post_norm_layer is not None:
            query = self.post_norm_layer(query)
        return query, query_per_layer
